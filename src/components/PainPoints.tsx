...
const pains = [
  ...
  },
  {
    ...
    description: "Enterprise CRMs charge a fortune for features you don't use. Our automations plug into what you already have—no expensive platform swap needed.",
  },
];
